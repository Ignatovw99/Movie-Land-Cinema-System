...
public class ProjectionConstants {
    ...
    public static final String PROJECTION_SHOULD_START_IN_CINEMA_WORKING_HOURS_RANGE = "Projection should start in cinema's working hours range and should be after %s";
